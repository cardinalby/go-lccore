...
type readinessRunFnAdapter struct {
...
// NewReadinessRunFnAdapter creates a new Adapter from `runFn` function.
...
func NewReadinessRunFnAdapter(
	runFn func(ctx context.Context, onReady func()) (err error),
) Adapter {
	return &readinessRunFnAdapter{
		runFn: runFn,
	}
}

func (a *readinessRunFnAdapter) OnStart() func(ctx context.Context) error {
	return a.start
}

func (a *readinessRunFnAdapter) OnWait() func() error {
	return a.wait
}

func (a *readinessRunFnAdapter) OnClose() func(ctx context.Context) error {
	return a.close
}
...
func (a *readinessRunFnAdapter) start(ctx context.Context) error {
...
func (a *readinessRunFnAdapter) wait() error {
	<-a.runDoneSignal
	return a.runResult
}
...
func (a *readinessRunFnAdapter) close(ctx context.Context) error {
