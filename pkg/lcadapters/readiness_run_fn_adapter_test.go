...
func TestNewRunnableNodeBehaviorAdapter(t *testing.T) {
	...
	adapter := NewReadinessRunFnAdapter(runnable.Run)
	require.NotNil(t, adapter)
}

func TestReadinessRunFnAdapter_Start_Success(t *testing.T) {
	runnable := &mockRunnable{
		runFunc: func(ctx context.Context, onReady func()) error {
			onReady()
			<-ctx.Done()
...
func TestReadinessRunFnAdapter_Start_ImmediateReturn(t *testing.T) {
...
func TestReadinessRunFnAdapter_Start_ContextCanceledBeforeReady(t *testing.T) {
...
func TestReadinessRunFnAdapter_Start_AlreadyRunning(t *testing.T) {
	runnable := &mockRunnable{
		runFunc: func(ctx context.Context, onReady func()) error {
			onReady()
			<-ctx.Done()
...
func TestReadinessRunFnAdapter_Wait_Success(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
...
func TestReadinessRunFnAdapter_Wait_WithError(t *testing.T) {
...
func TestReadinessRunFnAdapter_Close_Success(t *testing.T) {
	runnable := &mockRunnable{
		runFunc: func(ctx context.Context, onReady func()) error {
			onReady()
			<-ctx.Done()
...
func TestReadinessRunFnAdapter_Close_ReturnsNonContextError(t *testing.T) {
...
func TestReadinessRunFnAdapter_Close_PassesCloseContext(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
...
func TestReadinessRunFnAdapter_FullLifecycle(t *testing.T) {
	runnable := &mockRunnable{
		runFunc: func(ctx context.Context, onReady func()) error {
			onReady()
			<-ctx.Done()
...
func TestReadinessRunFnAdapter_ConcurrentWaitCalls(t *testing.T) {
	readySignal := make(chan struct{})
	runnable := &mockRunnable{
		runFunc: func(ctx context.Context, onReady func()) error {
			onReady()
...
func TestReadinessRunFnAdapter_Start_ReadyCalledMultipleTimes(t *testing.T) {
	runnable := &mockRunnable{
		runFunc: func(ctx context.Context, onReady func()) error {
			onReady()
...
func TestReadinessRunFnAdapter_Start_ReadyNeverCalled(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		runnable := &mockRunnable{
			runFunc: func(ctx context.Context, onReady func()) error {
				// Never call onReady
...
func TestReadinessRunFnAdapter_CloseContext_UsedDuringCleanup(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
